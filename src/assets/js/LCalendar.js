        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '<div>' +
                    '<div class="gear date_tt" data-datetype="date_yy"></div>' +
                    '<div class="date_grid">' +
                    '<div>时段</div>' +
                    '</div>' +
                    '</div>' +
                ...
                var date_tt = _self.gearDate.querySelector(".date_tt");
                date_yy.addEventListener('touchstart', gearTouchStart);
                date_mm.addEventListener('touchstart', gearTouchStart);
                date_dd.addEventListener('touchstart', gearTouchStart);
                date_tt.addEventListener('touchstart', gearTouchStart)
                date_yy.addEventListener('touchmove', gearTouchMove);
                date_mm.addEventListener('touchmove', gearTouchMove);
                date_dd.addEventListener('touchmove', gearTouchMove);
                date_tt.addEventListener('touchmove', gearTouchMove);
                date_yy.addEventListener('touchend', gearTouchEnd);
                date_mm.addEventListener('touchend', gearTouchEnd);
                date_dd.addEventListener('touchend', gearTouchEnd);
                date_tt.addEventListener('touchend', gearTouchEnd);
            }
            //初始化年月日插件默认值
            ...
            function dateTimeCtrlInit() {
                ...
                _self.gearDate.querySelector(".date_dd").setAttribute("val", dateArr.dd);
                setDateGearTooth();
                _self.gearDate.querySelector(".time_hh").setAttribute("val", 0);
            ...
            function setDateGearTooth() {
                ...
                // var ttStr = "";
                // if (date_yy && date_yy.getAttribute("val")) {
                //     date_tt.innerHTML = "<div class='tooth' data-time='9-14'>9-14</div>"+
                //         "<div class='tooth' data-time='14-19'>14-19</div>" +
                //         "<div class='tooth' data-time='19-9'>19-9</div>";
                //
                //     var top = Math.floor(parseFloat(date_yy.getAttribute('top')));
                //     if (!isNaN(top)) {
                //         top % 2 == 0 ? (top = top) : (top = top + 1);
                ...
                //         var minTop = 8 - (passY - 1) * 2;
                //         top < minTop && (top = minTop);
                //         date_tt.style["-webkit-transform"] = 'translate3d(0,' + top + 'em,0)';
                //         date_tt.setAttribute('top', top + 'em');
                //         ttVal = Math.abs(top - 8) / 2;
                //         date_tt.setAttribute("val", ttVal);
                //     } else {
                //         date_tt.style["-webkit-transform"] = 'translate3d(0,' + (8 - ttVal * 2) + 'em,0)';
                //         date_tt.setAttribute('top', 8 - ttVal * 2 + 'em');
                //     }
                // } else {
                //     return;
                // }
            ...
            function setTimeGearTooth() {
                ...
                if (time_hh && time_hh.getAttribute("val")) {
                    ...
                    // }
                    time_hh.innerHTML = "<div class='tooth' data-time='9-14'>9-14</div>"+
                        "<div class='tooth' data-time='14-19'>14-19</div>" +
                        "<div class='tooth' data-time='19-9'>19-9</div>";;
            ...
            function finishMobileDateTime(e) {
                ...
                var date_dd = parseInt(Math.round(_self.gearDate.querySelector(".date_dd").getAttribute("val"))) + 1;
                date_dd = date_dd > 9 ? date_dd : '0' + date_dd;
                var time_hh = parseInt(_self.gearDate.querySelector(".time_hh").getAttribute("val"));
                ...
                _self.trigger.value = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd + " " + (time_hh.length < 2 ? "0" : "") + time;
                closeMobileCalendar(e);
            }
            //时间确认
